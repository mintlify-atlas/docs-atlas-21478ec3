...
description: "Authenticate django-meta-whatsapp REST API requests using an X-API-Key header or api_key query param. Generate and manage keys under Settings → API Keys."
---
