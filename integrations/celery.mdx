---
title: "Async Campaign Execution with Celery"
sidebarTitle: "Celery"
description: "Enable Celery to run large WhatsApp campaigns asynchronously in the background, preventing web request timeouts for bulk sends."
---
